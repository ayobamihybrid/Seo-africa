...
const defaultFeaturedPost: BlogPost = {
  ...
  excerpt:
    "Crafting engaging presentations involves a blend of storytelling and visual appeal. Start by outlining your key points and supporting them with relevant data. Finally, us...",
