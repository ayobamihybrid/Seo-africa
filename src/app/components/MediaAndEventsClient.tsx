...
const MediaAndEventsClient: React.FC<MediaAndEventsClientProps> = ({
  mediaPageData: strapiData,
}) => {
            ...
            <div className="bg-[#3051F30D] py-8 sm:py-12 lg:py-[4.9rem] px-4 sm:px-6 lg:px-4 space-y-4 sm:space-y-6 lg:h-full lg:flex lg:flex-col lg:justify-center">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-sm text-gray-500">
                ...
                <span className="flex items-center gap-1">
                  <Clock className="w-4 h-4" />1 min read
                </span>
              </div>
...
export default MediaAndEventsClient;
