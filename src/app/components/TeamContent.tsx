...
import { bottomRowImages, topRowImages } from "../utils";
...
const TeamContent: React.FC<TeamContentProps> = ({
  ...
  const [activeMemberMobile, setActiveMemberMobile] = useState<number | null>(
    null
  );
  ...
  const groupMembersBySection = (members: TeamMember[]) => {
  ...
  const getTeamMemberImageUrl = (member: TeamMember | any) => {
    if (member.avatar?.url) {
      return member.avatar.url.startsWith("http")
        ? member.avatar.url
        : member.avatar.url;
    }
    return "/team1.png";
  ...
  const handleMemberClick = (memberId: number) => {
    if (activeMemberMobile === memberId) {
      setActiveMemberMobile(null);
    } else {
      setActiveMemberMobile(memberId);
    }
  };
  ...
  return (
    <>
      <style jsx global>{`
        ...
        /* Custom styles for mobile interaction */
          ...
          <div className="mb-16 lg:mb-24">
            ...
            >
              <span className="bg-gradient-to-r from-[#E8913A] to-[#ED60A4] bg-clip-text text-transparent text-xl font-bold">
                {teamData.hero_section.accent_text}
              </span>
            </div>
      ...
      <section className="bg-white pb-16 lg:pb-24 relative">
        <div className="absolute top-0 left-0 right-0 z-20 px-4 sm:px-6 lg:px-12 -translate-y-1/2">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <Image
                src={
                  getStrapiImageUrl(teamData.hero_section.cover_image) ||
                  "/ourteam1.png"
                }
                alt={
                  teamData.hero_section.cover_image.alternativeText ||
        ...
        <div className="pt-60 md:pt-64 lg:pt-[25rem]">
            ...
            >
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: teamData.member_section.content.replace(
                    /\n/g,
                    "</p><p>"
                  ),
                }}
          ...
          <div
            ...
            style={{ transitionDelay: "200ms" }}
          >
            <h2>{teamData.member_section.title}</h2>
          </div>
          ...
          >
            {(() => {
              const groupedMembers = groupMembersBySection(displayTeamMembers);

              return Object.entries(groupedMembers).map(
                ([sectionName, members], sectionIndex) => (
                  <div
                    key={sectionName}
                    className={sectionIndex > 0 ? "mt-16 lg:mt-20" : ""}
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                      {members.map((member, index) => (
                        <div
                          key={member.id}
                          className="group team-member-card"
                          style={{
                            transitionDelay: `${
                              600 +
                              (sectionIndex * members.length + index) * 100
                            }ms`,
                          }}
                        ...
                        >
                          <div className="relative mb-6 overflow-hidden rounded-lg aspect-[4/5]">
                            ...
                            <div className="hidden absolute inset-0 bg-gradient-to-t from-purple-600/95 via-purple-500/80 to-transparent p-6 text-white md:flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            ...
                            <div
                              className={`md:hidden absolute inset-0 bg-gradient-to-t from-purple-600/95 via-purple-500/80 to-transparent p-6 text-white flex flex-col justify-end transition-opacity duration-300 ${
                                activeMemberMobile === member.id
                                  ? "opacity-100"
                                  : "opacity-0"
                              }`}
                            >
                            ...
                            <div className="md:hidden absolute top-4 right-4 bg-black/30 rounded-full p-2">
                              <svg
        ...
        >
          <div className="relative">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-4">
              {teamData.team_gallery_section.title}
            </h2>
      ...
      >
        ...
        <FindOpportunities
          talentData={
            teamData.talent_cta_section
              ? {
                  title: teamData.talent_cta_section.title,
                  cta_text: teamData.talent_cta_section.cta_text,
                  cover_image: {
                    url: teamData.talent_cta_section.cover_image.url,
                    alternativeText:
                      teamData.talent_cta_section.cover_image.alternativeText,
                  },
                }
              : undefined
          }
